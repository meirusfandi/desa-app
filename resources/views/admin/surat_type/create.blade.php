            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="POST" action="{{ route('admin.master.jenis-surat.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12 mt-3">
                                            <div class="form-group">
                                                ...
                                                <textarea id="template_html" class="form-control @error('template_html') is-invalid @enderror"
                                                    name="template_html" rows="6" placeholder="(Opsional) tidak digunakan jika memakai DOCX">{{ old('template_html') }}</textarea>
                                                @error('template_html')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Optional: Re-populate old inputs if validation failed (server-side rendering would be better but this is MVP)
        @if(old('input_fields'))
